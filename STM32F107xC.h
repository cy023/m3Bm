 ...
 * @file STM32F107xC.h
 * @author cy023
 * @brief STM32F107xC Register Definitions and Cortex-M3 Supplement Definitions
 * @date 2021.05.28
 */

#ifndef __STM32F107xC
#define __STM32F107xC
...
#define NVIC_ISER7          (*(volatile uint32_t *)0xE000E10C)
#define NVIC_ICER           ( (volatile uint32_t *)0xE000E180)
#define NVIC_ICER0          (*(volatile uint32_t *)0xE000E184)
#define NVIC_ICER1          (*(volatile uint32_t *)0xE000E188)
#define NVIC_ICER2          (*(volatile uint32_t *)0xE000E18C)
#define NVIC_ICER3          (*(volatile uint32_t *)0xE000E180)
#define NVIC_ICER4          (*(volatile uint32_t *)0xE000E194)
#define NVIC_ICER5          (*(volatile uint32_t *)0xE000E198)
#define NVIC_ICER6          (*(volatile uint32_t *)0xE000E19C)
#define NVIC_ICER7          (*(volatile uint32_t *)0xE000E190)
